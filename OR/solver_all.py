...
pd.DataFrame(dispatch_records).to_csv("dispatch_result_all.csv", index=False)
pd.DataFrame(hide_records).to_csv("hide_result_all.csv", index=False)
print("✅ 結果已輸出為 dispatch_result_all.csv 與 hide_result_all.csv")
